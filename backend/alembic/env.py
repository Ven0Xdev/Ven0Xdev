...
The connection URL always comes from `app.core.config.Settings`
(environment-driven), never from alembic.ini, so migrations run against
whatever database the app itself would use in that environment.
"""
